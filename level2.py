...
class Level2:
	...
	def create_map(self):
		...
		graphics = {
			'grass': import_folder('graphics/Grass2'),
			'objects': import_folder('graphics/objects2')
		}
	...
	def display_victory_message(self):
		...
		game_over_surface = game_over_font.render('You wing', True, (255, 0, 0))
		game_over_rect = game_over_surface.get_rect(center=(WIDTH // 2, HEIGTH // 2))
...
class YSortCameraGroup(pygame.sprite.Group):
	def __init__(self):
		...
		# creating the floor
		self.floor_surf = pygame.image.load('graphics/tilemap/groundDia.png').convert()
